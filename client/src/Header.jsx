...
export default function Header()
{
    return (
        ...
        <div className="flex border border-gray-300 rounded-full py-2 px-4 shadow-sm hover:shadow-md transition-shadow duration-150">
          ...
          <div className="border-l border-gray-300 h-full mx-2"></div> {/* Divider */}
        ...
        <Link to={'/login'} className="flex border items-center gap-4 border-gray-300 rounded-full py-1 px-2 shadow-sm hover:shadow-md transition-shadow duration-150">
