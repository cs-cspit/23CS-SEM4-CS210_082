...
export default function PhotosUploader({ addedPhotos, onChange }) {
  ...
  async function addPhotoByLink(ev) {
    ...
    try {
      ...
      addToast(
        "Failed to add photo. Please check the link and try again.",
        "error"
      );
    }
  }
  ...
  function uploadPhoto(ev) {
    ...
    axios
      ...
      .then((response) => {
        ...
        const processedFilenames = filenames.map((path) => {
        ...
        onChange((prev) => [...prev, ...processedFilenames]);
  ...
  function selectAsMainPhoto(ev, filename) {
    ...
    addToast("Main photo updated", "success");
  }
